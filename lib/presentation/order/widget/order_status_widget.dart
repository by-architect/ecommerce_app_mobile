...
class OrderStatusWidget extends StatelessWidget {
  const OrderStatusWidget({super.key, required this.purchaseProcess, required this.onCancel});
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          Column(
            children: List.generate(purchaseProcess.selectedProducts.length, (index) {
              return Padding(
                padding: const EdgeInsets.all(AppSizes.spaceBtwHorizontalFieldsSmall),
                child: Row(
                  children: [
                    Expanded(
                        child: ProductCardLarge(
                            product: purchaseProcess.selectedProducts[index].product, onPressed: () {})),
                  ],
                ),
              );
            }),
          ...
          if (purchaseProcess.processStatusList.last.purchaseStatusType == PurchaseStatusType.payingSuccess ||
              purchaseProcess.processStatusList.last.purchaseStatusType == PurchaseStatusType.orderTaken)
            Row(
              children: [
                TextButtonDefault(
                  onPressed: onCancel,
