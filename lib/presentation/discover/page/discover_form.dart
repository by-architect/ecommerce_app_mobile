                ...
                children: [
                  TextFieldSearch(
                    onFieldSubmitted: (value) {
                      SearchScreen.getProducts(
                        outContext: context, events: [], features: widget.features,);

                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            SearchScreen.getProducts(events: [SearchTextEvent(value ?? "")],
                              outContext: context,
                        ...
                        children: [
                          ...
                          Text(
                            discoverState.categoryStruct.isFirstLayer
                                ...
                                : "${AppText.commonPageCategories} > ${discoverState.categoryStruct
                                .title}",
                            style: Theme
                                .of(context)
                                .textTheme
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          ProductListTile(
                            ...
                            press: () {
                              if (discoverState.categoryStruct.isLastLayer(discoverState.categoryStruct
                                  .currentLayer[index])) {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      SearchScreen.getProducts(
                                          ...
                                          events: [
                                            SelectedCategoriesEvent(
                                                [discoverState.categoryStruct.currentLayer[index]])
                                          ], outContext: context),
                                ));
                              } else {
                                BlocProvider.of<DiscoverBloc>(context)
                                    .add(NextCategoryLayerEvent(
                                    discoverState.categoryStruct.currentLayer[index]));
                              }
                              /*
